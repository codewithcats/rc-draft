...
function setDevice() {
	device_xs = $("#device-xs").is(":visible")
}
function round(n, t) {
...
function scrollPosition() {
	...
	$(document).on("scrollstop", function () {
		var n = {page: window.location.pathname, scrollPos: $(window).scrollTop()};
		document.cookie = "keepscroll=" + JSON.stringify(n)
	});
	if (window.location.hash == "")for (var t = document.cookie ? document.cookie.split(";") : [], i = 0, u = t.length; i < t.length; i++)if (r = t[i].split("="), r[0].trim() == "keepscroll") {
		n = $.parseJSON(r[1]);
		n.page && n.page == window.location.pathname ? $(window).scrollTop(n.scrollPos) : document.cookie = "keepscroll=;expires=Thu, 01 Jan 1970 00:00:01 GMT;";
		break
	}
}
function toggleFooter() {
	var t = $("#sticky-footer-content"), n = parseInt(t.css("margin-bottom")) < 0 ? !1 : !0;
	device_xs ? n ? closeFooter() : showFooter() : device_xs || n || showFooter()
}
function closeFooter() {
	var n = $("#sticky-footer-content");
	n.clearQueue().animate({marginBottom: "-" + n.outerHeight() + "px"}, 500, function () {
	})
}
function showFooter() {
	var n = $("#sticky-footer-content");
	n.clearQueue().animate({marginBottom: "0px"}, 500, function () {
	})
}
function initializeFooter() {
	$(".toggle-footer-btn").click(function () {
		device_xs && toggleFooter()
	});
	$(".toggle-footer-btn, .sticky-footer").swipe({
		swipeUp: function () {
			showFooter()
		}, swipeDown: function () {
			closeFooter()
	...
	$(document).click(function (n) {
		$(n.target).closest("#sticky-footer").length || device_xs && closeFooter()
	});
	toggleFooter()
}
function initializeSearch() {
	$(".navbar-toggle").click(function () {
		$("#hdr-search input").val("")
	});
	$(".toggle-search-btn").click(function () {
		var n = $("#toggle-search");
		n.next("ul").is(":visible") ? n.next("ul").fadeOut(200) : n.next("ul").fadeIn(1e3);
		n.clearQueue().toggle("slide", {direction: "right"}, 500);
		$("#hdr-search2 input").val("")
	});
	$(".btn-search-clear").click(function () {
		$("#hdr-search2 input").val("")
	})
}
function validateZip(n) {
	var t = new RegExp("^\\d{5}(-\\d{4})?$");
	return t.test(n.value) == !1 ? !1 : !0
}
function validateEmpty(n) {
	return n.value ? !0 : !1
}
function initializeMegaMenu() {
	var t = $(".primary-nav-sm >li"), n;
	t.hover(function () {
		var n, t, i;
		device_xs || (n = $(this).find(".mega-menu"), t = $(this).find("> a"), n.length && (t.addClass("active"), n.show(), i = $(this).width(), $(this).prepend("<div class='mm-pointer' style='width:" + i + "px;'><\/div>")))
	}, function () {
		var n = $(this).find(".mega-menu"), t = $(this).find("> a");
		n.length && (t.removeClass("active"), $(this).find(".mm-pointer").remove(), $(this).find(".mega-menu").hide())
	});
	n = $(".product-selector div");
	n.click(function () {
		var t = $(".product-filters"), i;
		n.removeClass("active");
		t.removeClass("active");
		i = $(this).attr("class");
		$(this).addClass("active");
		t.each(function () {
			$(this).hasClass(i) && $(this).addClass("active")
		})
	})
}
function initializeUtilityCallout() {
	var n = $("#utility-nav-exp");
	$("#utility-nav-callout").hover(function () {
		n.show()
	}, function () {
		n.hide()
	})
}
function initializeMMSelects() {
	$("#product-filter-wrapper select").selectmenu({appendTo: "#product-filter-wrapper"});
	$(".toggle-nav").click(function () {
		$(this).hasClass("ui-corner-top") ? $(this).removeClass("ui-corner-top") : $(this).addClass("ui-corner-top");
		var n = $(this).next(".toggle-nav-content"), t = $(window).height(), i = $(this).offset(), r = i.top - $(document).scrollTop(), u = t - r - $(this).height() - 65;
		n.css("max-height", u);
		n.toggle()
	});
	$(".toggle-nav").css("width", "100%");
	$(".mega-menu .ui-selectmenu-button").click(function () {
		var n = 30, i = device_xs ? 45 : 90, r = $(this).attr("aria-owns"), u = $("#" + r), f = $(window).height(), e = $(this).offset(), o = e.top - $(document).scrollTop(), t = f - o - $(this).height() - i, s = t > n ? t : n;
		u.css("max-height", s)
	})
}
function initializePush() {
	$(".toggle-menu").jPushMenu({closeOnClickLink: !1})
}
function setEqualHeight(n, t) {
	t ? $(n).each(function () {
		var n = 0;
		$("> div", this).each(function () {
			$(this).outerHeight() > n && (n = $(this).outerHeight())
		});
		$("> div", this).css("min-height", n + "px")
	}) : $(n).each(function () {
		$("> div", this).each(function () {
			$(this).css("min-height", "")
		})
...
function RedirectToProductSearch(n, t, i) {
	var r = "";
	$("." + n).each(function () {
		var n = $(this).val();
		n != "-" && (r += n + "|")
	});
	r == "" ? window.location = i + "?categoryName=" + t : (r = r.substring(0, r.length - 1), window.location = i + "?categoryName=" + t + "&filters=" + r)
}
function initializeAccordians() {
	$(".acc-group").accordion({collapsible: !0, active: !1, header: ".acc-question"});
	$(".acc-expand-all-wrapper").click(function () {
		var n = $(this), t = n.find(".acc-expand-all");
		n.hasClass("active") ? ($(".acc-question").removeClass("ui-accordion-header-active").removeClass("ui-state-active").removeClass("ui-state-active").addClass("ui-state-default"), $(".acc-answer").hide(function () {
			t.text("EXPAND ALL");
			n.removeClass("active")
		})) : ($(".acc-question").addClass("ui-accordion-header-active").addClass("ui-state-active").addClass("ui-state-active").removeClass("ui-state-default"), $(".acc-answer").show(function () {
			t.text("COLLAPSE ALL");
			n.addClass("active")
		}))
	})
...
function hatStyles() {
	var n = function () {
		...
		return n.setAttribute("media", "screen"), n.appendChild(document.createTextNode("")), document.head.appendChild(n), n.sheet
	}();
	n.insertRule("body.with-hat {/* original padding is 81px (81px + 75px) */padding-top: 156px;}", 0);
	n.insertRule(".with-hat #header-nav {min-height: 156px;}", 0);
	n.insertRule(".with-hat #navbar-collapse.cbp-spmenu-open {top: 156px;}", 0);
	n.insertRule("#global-hat {height: 75px;border: none;border-radius:0;border-bottom: 1px solid #666;padding-bottom:10px;padding-top:5px; margin-bottom:0;font-size: 12px}", 0);
	n.insertRule("#global-hat .close {position:absolute; top:25px; right:15px;}", 0);
	n.insertRule("#global-hat .country-link {width: 55%; padding-right: 0; padding-left: 5px;}", 0);
	n.insertRule("#global-hat .country-dropdown {width: 45%; padding-left: 0;}", 0);
	n.insertRule(".country-name, #current-country {white-space: nowrap;}", 0);
	n.insertRule("@media (min-width: 768px) {#global-hat {height: 50px !important;font-size: 18px !important;}}", 0);
	n.insertRule("@media (min-width: 768px) {body.with-hat {/* original padding is 125px (125px + 50px) */padding-top: 175px !important;}}", 0);
	n.insertRule("@media (min-width: 768px) {#global-hat .close {top:15px !important;}}", 0)
}
function globalHat() {
	$.cookie("no-hat") === null && (hatStyles(), getCurrentCountry())
}
function getCurrentCountry() {
	$.ajax({
		url: "//www.telize.com/geoip", type: "post", data: "", dataType: "json", success: function (n, t) {
			t == "success" && getCountryUrlWithName(n.country)
		}
	})
}
function getCountryUrlWithName(n) {
	var t = {
		Argentina: "http://www.royal-canin.com.ar",
		Australia: "http://www.royalcanin.com.au",
		Austria: "http://www.royal-canin.at",
		Belgium: "http://www.royalcanin.be",
		Brazil: "http://www.royalcanin.com.br",
		Bulgaria: "http://www.royalcanin.bg",
		Canada: "http://www.royalcanin.ca",
		China: "http://www.royal-canin.cn",
		"Czech Republic": "http://www.royalcanin.cz",
		Denmark: "http://www.royalcanin.dk",
		Estonia: "http://www.royal-canin.ee",
		Finland: "http://www.royalcanin.fi",
		France: "http://www.royalcanin.fr",
		Germany: "http://www.royal-canin.de",
		Greece: "http://www.royalcanin.gr",
		Holland: "http://www.royalcanin.nl",
		"Hong Kong": "http://www.royalcanin.hk",
		Hungary: "http://www.royalcanin.hu",
		Iceland: "http://www.royalcanin.is",
		India: "http://www.royalcanin.in",
		Indonesia: "http://www.royalcanin.co.id",
		Israel: "http://www.royalcanin.co.il",
		Italy: "http://www.royalcanin.it",
		Japan: "http://www.royalcanin.co.jp",
		Korea: "http://www.royalcanin.co.kr",
		"La Réunion": "http://www.royalcanin.re",
		Latvia: "http://www.royalcanin.lv",
		Lithuania: "http://www.royalcanin.lt",
		"Malaysia ": "http://www.royalcanin.my",
		Mexico: "http://www.royalcanin.com.mx",
		"New Zealand": "http://www.royalcanin.co.nz",
		Norway: "http://www.royalcanin.no",
		Philippine: "http://www.royalcanin.ph",
		Poland: "http://www.royal-canin.pl",
		"Puerto Rico": "http://www.royalcanin.pr",
		Romania: "http://www.royalcanin.ro",
		Russia: "http://www.royal-canin.ru",
		Singapore: "http://www.royalcanin.sg",
		Slovakia: "http://www.royalcanin.sk",
		"South Africa": "http://www.royalcanin.co.za",
		Spain: "http://www.royalcanin.es",
		Sweden: "http://www.royalcanin.se",
		Switzerland: "http://www.royal-canin.ch",
		Taiwan: "http://www.royalcanin.com.tw",
		Thailand: "http://www.royal-canin.co.th",
		Turkey: "http://www.royalcanin.com.tr",
		Ukraine: "http://www.royalcanin.com.ua",
		"United Kingdom": "http://www.royalcanin.co.uk",
		"United States": "https://www.royalcanin.com"
	}, i = new RegExp("https?.*(royal.*)"), r = i.exec(t[n]), u = "https?:\\/\\/(?:www\\.)?" + r[1] + "$", f = new RegExp(u);
	document.location.origin.match(f) === null && makeHat(t, n)
}
function makeHat(n, t) {
	$("#header-nav").prepend('<div id="global-hat" class="alert-info alert alert-dismissible fade in container-fluid" role="alert">         <div class="container">             <div class="row">             <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">�<\/span><\/button>             <div class="col-md-6">                 Visit Royal Canin in your country: <a id="current-country" href="#">                     <span class="country-name"><\/span>                 <\/a>             <\/div>             <div class="col-md-6">                 Or you can visit <select id="countries-link">                     <option value="" disabled="disabled" disabled selected style="display:none;">Select a Site<\/option>                     <option value="http://www.royalcanin-world.com">Royal Canin World<\/option>                 <\/select>             <\/div>             <\/div>         <\/div>     <\/div>');
	$("#current-country").attr("href", n[t]);
	$(".country-name").html(t);
	$.each(n, function (n, t) {
		$("#countries-link").append($("<option><\/option>").attr("value", t).text(n))
	});
	$("#countries-link").change(function () {
		document.location.href = $(this).find("option:selected").val()
	});
	$("#global-hat").on("close.bs.alert", function () {
		closeHat()
	});
	$("body").addClass("with-hat")
}
function closeHat() {
	$.cookie("no-hat", "1", {expires: 365, path: "/"});
	$("body").removeClass("with-hat")
}
function SU_getCountryUrlWithName(n) {
	SU_drawSubsidiariesUrlHeader({
		Argentina: "http://www.royal-canin.com.ar",
		Australia: "http://www.royalcanin.com.au",
		Austria: "http://www.royal-canin.at",
		Belgium: "http://www.royalcanin.be",
		...
		Italy: "http://www.royalcanin.it",
		Japan: "http://www.royalcanin.co.jp",
		Korea: "http://www.royal-canin.co.kr",
		"La Réunion": "http://www.royalcanin.re",
		Latvia: "http://www.royalcanin.lv",
		Lithuania: "http://www.royalcanin.lt",
		"Malaysia ": "http://www.royalcanin.my",
		Mexico: "http://www.royalcanin.com.mx",
		"New Zealand": "http://royalcanin.co.nz",
		Norway: "http://www.royalcanin.no",
		Philippine: "http://www.royalcanin.ph",
		Poland: "http://www.royal-canin.pl",
		"Puerto Rico": "http://www.royalcanin.pr",
		...
		Ukraine: "http://www.royalcanin.com.ua",
		"United Kingdom": "http://www.royalcanin.co.uk",
		"United States": "http://www.royalcanin.com"
	}, n)
}
function SU_drawSubsidiariesUrlHeader(n, t) {
	$("#su-current-country").attr("href", n[t]);
	$(".su-country-name").html(t);
	$.each(n, function (n, t) {
		$("#su-countries-link").append($("<option><\/option>").attr("value", t).text(n))
	});
	$("#su-countries-link").change(function () {
		document.location.href = $(this).find("option:selected").val()
	});
	$("#su-close").click(function () {
		SU_closeHeader()
	});
	$("#subsidiaries-url").slideDown()
}
function SU_closeHeader() {
	$.cookie("su-no-redirect", "1", {expires: 365, path: "/"});
	$("#subsidiaries-url").slideUp()
}
...
function initializeSelector() {
	$(".selector-cat").click(function () {
		var n = "none";
		return $(this).hasClass("cat") ? n = "cat" : $(this).hasClass("dog") && (n = "dog"), $(".selector-content").hide(), $(".selector-content").each(function () {
			$(this).hasClass(n) && ($(".selector-content-both").hide(), $(this).show(), setSelectorHeight())
		}), !1
	});
	$(".selector-category-col-content").click(function () {
		var n, t;
		return $(".selector-category-col-content").removeClass("active"), n = $(this).parent().index(), $(this).addClass("active"), t = $(this).find("img"), $(".selector-category-sprite img").css("margin-top", "-" + t.height() / 2 + "px"), t.css("margin-top", "0px"), n > 0 && ($(".selector-blurb-text").hide(), $(this).closest(".selector-content").find(".selector-blurb-text:eq(" + n + ")").show()), !1
	});
	$(".selector-close").click(function () {
		return $(".selector-category-col-content").removeClass("active"), $(".selector-blurb-text").hide(), $(".selector-blurb-text.default").show(), $(".selector-content").hide(), $(".selector-content-both").show(), !1
	})
}
function setSelectorHeight() {
	$(".selector-category-col-content").each(function () {
		var i = $(this).find(".selector-category-sprite"), n = $(this).find(".img-responsive:first-child"), t = n.height();
		n.css("margin-top", "-" + Math.floor(t / 2) + "px");
		i.height(Math.floor(t / 2));
		$(this).hover(function () {
			n.css("margin-top", "0px")
		}, function () {
			$(this).hasClass("active") || n.css("margin-top", "-" + Math.floor(t / 2) + "px")
		})
	})
}
function initializeTiles() {
	$(".tile-img").each(function () {
		var n = $(this).find("img"), t = n.height();
		$(this).height(Math.floor(t / 2)).css("visibility", "visible").hover(function () {
			n.css("margin-top", "-" + Math.floor(t / 2) + "px")
		}, function () {
			n.css("margin-top", "0px")
		})
...
function initFacetSelector() {
	var n = $(".prd-header-right");
	n.click(function () {
		toggleFilters()
	});
	$(document).on("scrollstop", function () {
...
function toggleFilters(n) {
	$("#pinned-product-filter-wrapper select").selectmenu("refresh");
	var i = $(".prd-header-right"), r = $(".prd-header-left").outerWidth() + 1, t = $("#product-filter-flyout");
	i.removeClass("shadow");
	parseInt(t.css("margin-left")) < 0 && !n ? (t.hasClass("shadow") || t.addClass("shadow"), t.clearQueue().animate({marginLeft: ""}, 500, function () {
		i.find(".filter-arrow").addClass("active")
	})) : t.clearQueue().animate({marginLeft: "-" + r + "px"}, 500, function () {
		i.find(".filter-arrow").removeClass("active");
		device_xs ? (i.addClass("shadow"), t.removeClass("shadow")) : t.hasClass("shadow") || t.addClass("shadow")
	})
}
function slideFacetSelector() {
	var n = 18, e = $("#header-nav").outerHeight(), t = $("#product-filter-flyout"), o = $(".product-results-content"), i = o.offset(), r = 0, u, f, s;
	r = i && i.length ? i.top - $(window).scrollTop() : 0;
	u = o.height() - t.height() - n;
	r + n <= e ? (f = e - r + n, s = f > u ? u : f, t.css("top", s)) : t.css("top", n)
}
function initializeSelects() {
	$("#pinned-product-filter-wrapper select").selectmenu({
		appendTo: "body", change: function (n, t) {
			var r = t.item.element, i = $(r).parent().parent().find(".facet-selected");
			t.item.value != "-" ? i.addClass("active") : i.removeClass("active")
		}
	});
	$(".pinned-prod-filters .ui-selectmenu-button").click(function () {
		var n = 30, i = device_xs ? 45 : 90, r = $(this).attr("aria-owns"), u = $("#" + r), f = $(window).height(), e = $(this).offset(), o = e.top - $(document).scrollTop(), t = f - o - $(this).height() - i, s = t > n ? t : n;
		u.css("max-height", s)
	})
}
function laodBV() {
	var t = [], n = $(".bv-container");
	$.each(n, function (n, i) {
		var r = i.getAttribute("bv-id");
		r && r.length > 0 && t.push(parseInt(r))
	});
	n && n.length > 0 && $BV.ui("rr", "inline_ratings", {productIds: t, containerPrefix: "BVRRInlineRating"})
}
function setMinProductsHeight() {
	var n = $("#product-filter-flyout").outerHeight() + 35;
	$(".product-results-content").css("min-height", n)
}
!function (n, t) {
	...
	p = function (n) {
		...
		r.attr = function (n, i) {
			...
			var f = t.attrHandle[i.toLowerCase()], r = f && di.call(t.attrHandle, i.toLowerCase()) ? f(n, i, !l) : void 0;
	...
	var rt, wt, ro = /^(?:toggle|show|hide)$/, gu = new RegExp("^(?:([+-])=|)(" + at + ")([a-z%]*)$", "i"), uo = /queueHooks$/, bt = [fo], st = {
		"*": [function (n, t) {
			var f = this.createTween(n, t), s = f.cur(), r = gu.exec(t), e = r && r[3] || (i.cssNumber[n] ? "" : "px"), u = (i.cssNumber[n] || "px" !== e && +s) && gu.exec(i.css(f.elem, n)), o = 1, h = 20;
			if (u && u[3] !== e) {
				e = e || u[3];
				r = r || [];
				u = +s || 1;
...
(function (n) {
	...
	n.ui.button;
	n.extend(n.ui, {datepicker: {version: "1.11.2"}});
	...
	n.ui.plugin.add("resizable", "alsoResize", {
		start: function () {
			...
			var r = n(this).resizable("instance"), u = r.options, f = r.originalSize, e = r.originalPosition, s = {
	...
	n.effects = {effect: {}}, function (n, t) {
		...
		n.extend(n.effects, {
			version: "1.11.2", save: function (n, t) {
	...
	n.widget("ui.tooltip", {
		version: "1.11.2", options: {
			...
			r && (u = r.tooltip, r.closing || (clearInterval(this.delayedShow), i.data("ui-tooltip-title") && !i.attr("title") && i.attr("title", i.data("ui-tooltip-title")), this._removeDescribedBy(i), r.hiding = !0, u.stop(!0), this._hide(u, this.options.hide, function () {
				...
				delete f.parents[t]
			}), r.closing = !0, this._trigger("close", t, {tooltip: u}), r.hiding || (r.closing = !1)))
		}, _tooltip: function (t) {
	...
	function et(ft, et) {
		function di(t) {
			if (!vu() && !(n(t.target).closest(et.excludedElements, ot).length > 0)) {
				...
				return (ht = rt, r ? ct = u.touches.length : t.preventDefault(), at = 0, vt = null, bt = null, lt = 0, kt = 0, dt = 0, yt = 1, wt = 0, st = pu(), si = bu(), dr(), !r || ct === et.fingers || et.fingers === l || ui() ? (or(0, e), wi = ni(), ct == 2 && (or(1, u.touches[1]), kt = dt = sr(st[0].start, st[1].start)), (et.swipeStatus || et.pinchStatus) && (f = pt(u, ht))) : f = !1, f === !1) ? (ht = i, pt(u, ht), f) : (et.hold && (ki = setTimeout(n.proxy(function () {
					ot.trigger("hold", [u.target]);
					et.hold && (f = et.hold.call(ot, u, u.target))
				}, this), et.longTapThreshold)), ai(!0), null)
			}
		}

		function gi(n) {
			var u = n.originalEvent ? n.originalEvent : n, o, h, f, e, c;
			ht === t || ht === i || gr() || (h = r ? u.touches[0] : u, f = nu(h), hi = ni(), r && (ct = u.touches.length), et.hold && clearTimeout(ki), ht = s, ct == 2 && (kt == 0 ? (or(1, u.touches[1]), kt = dt = sr(st[0].start, st[1].start)) : (nu(u.touches[1]), dt = sr(st[0].end, st[1].end), bt = du(st[0].end, st[1].end)), yt = ku(kt, dt), wt = Math.abs(kt - dt)), ct === et.fingers || et.fingers === l || !r || ui() ? (vt = tf(f.start, f.end), uu(n, vt), at = gu(f.start, f.end), lt = iu(), wu(vt, at), (et.swipeStatus || et.pinchStatus) && (o = pt(u, ht)), (!et.triggerOnTouchEnd || et.triggerOnTouchLeave) && (e = !0, et.triggerOnTouchLeave && (c = rf(this), e = uf(f.end, c)), !et.triggerOnTouchEnd && e ? ht = ir(s) : et.triggerOnTouchLeave && !e && (ht = ir(t)), (ht == i || ht == t) && pt(u, ht))) : (ht = i, pt(u, ht)), o === !1 && (ht = i, pt(u, ht)))
		}

		function nr(n) {
			var u = n.originalEvent;
			return r && u.touches.length > 0 ? (au(), !0) : (gr() && (ct = bi), hi = ni(), lt = iu(), ur() || !rr() ? (ht = i, pt(u, ht)) : et.triggerOnTouchEnd || et.triggerOnTouchEnd == !1 && ht === s ? (n.preventDefault(), ht = t, pt(u, ht)) : !et.triggerOnTouchEnd && br() ? (ht = t, ri(u, ht, w)) : ht === s && (ht = i, pt(u, ht)), ai(!1), null)
		}
		...
		function ir(n) {
			var r = n, f = cr(), u = rr(), e = ur();
			return !f || e ? r = i : u && n == s && (!et.triggerOnTouchEnd || et.triggerOnTouchLeave) ? r = t : !u && n == t && et.triggerOnTouchLeave && (r = i), r
		}

		function pt(n, u) {
			var f = undefined;
			return yr() || fr() || ar() || ui() ? ((yr() || fr()) && (f = ri(n, u, g)), (ar() || ui()) && f !== !1 && (f = ri(n, u, nt))) : cu() && f !== !1 ? f = ri(n, u, tt) : lu() && f !== !1 ? f = ri(n, u, it) : hu() && f !== !1 && (f = ri(n, u, w)), u === i && ii(n), u === t && (r ? n.touches.length == 0 && ii(n) : ii(n)), f
		}

		function ri(r, s, h) {
			var c = undefined;
			if (h == g) {
				if (ot.trigger("swipeStatus", [s, vt || null, at || 0, lt || 0, ct, st]), et.swipeStatus && (c = et.swipeStatus.call(ot, r, s, vt || null, at || 0, lt || 0, ct, st), c === !1))return !1;
				if (s == t && vr()) {
					if (ot.trigger("swipe", [vt, at, lt, ct, st]), et.swipe && (c = et.swipe.call(ot, r, vt, at, lt, ct, st), c === !1))return !1;
					switch (vt) {
						case u:
							ot.trigger("swipeLeft", [vt, at, lt, ct, st]);
							et.swipeLeft && (c = et.swipeLeft.call(ot, r, vt, at, lt, ct, st));
							break;
						case f:
							ot.trigger("swipeRight", [vt, at, lt, ct, st]);
							et.swipeRight && (c = et.swipeRight.call(ot, r, vt, at, lt, ct, st));
							break;
						case e:
							ot.trigger("swipeUp", [vt, at, lt, ct, st]);
							et.swipeUp && (c = et.swipeUp.call(ot, r, vt, at, lt, ct, st));
							break;
						case o:
							ot.trigger("swipeDown", [vt, at, lt, ct, st]);
							et.swipeDown && (c = et.swipeDown.call(ot, r, vt, at, lt, ct, st))
					}
				}
			}
			if (h == nt) {
				if (ot.trigger("pinchStatus", [s, bt || null, wt || 0, lt || 0, ct, yt, st]), et.pinchStatus && (c = et.pinchStatus.call(ot, r, s, bt || null, wt || 0, lt || 0, ct, yt, st), c === !1))return !1;
				if (s == t && lr())switch (bt) {
					case v:
						ot.trigger("pinchIn", [bt || null, wt || 0, lt || 0, ct, yt, st]);
						et.pinchIn && (c = et.pinchIn.call(ot, r, bt || null, wt || 0, lt || 0, ct, yt, st));
						break;
					case y:
						ot.trigger("pinchOut", [bt || null, wt || 0, lt || 0, ct, yt, st]);
						et.pinchOut && (c = et.pinchOut.call(ot, r, bt || null, wt || 0, lt || 0, ct, yt, st))
				}
			}
			return h == w ? (s === i || s === t) && (clearTimeout(li), clearTimeout(ki), er() && !eu() ? (gt = ni(), li = setTimeout(n.proxy(function () {
				gt = null;
				ot.trigger("tap", [r.target]);
				et.tap && (c = et.tap.call(ot, r, r.target))
			}, this), et.doubleTapThreshold)) : (gt = null, ot.trigger("tap", [r.target]), et.tap && (c = et.tap.call(ot, r, r.target)))) : h == tt ? (s === i || s === t) && (clearTimeout(li), gt = null, ot.trigger("doubletap", [r.target]), et.doubleTap && (c = et.doubleTap.call(ot, r, r.target))) : h == it && (s === i || s === t) && (clearTimeout(li), gt = null, ot.trigger("longtap", [r.target]), et.longTap && (c = et.longTap.call(ot, r, r.target))), c
		}
		...
		function uu(n, t) {
			if (et.preventDefaultEvents !== !1)if (et.allowPageScroll === p)n.preventDefault(); else {
		...
		function pr() {
			return ct === et.fingers || et.fingers === l || !r
		}
		...
		function ou() {
			return (ct === 1 || !r) && (isNaN(at) || at < et.threshold)
		}
		...
		function ai(n) {
			n === !0 ? (ot.bind(yi, gi), ot.bind(pi, nr), ti && ot.bind(ti, tr)) : (ot.unbind(yi, gi, !1), ot.unbind(pi, nr, !1), ti && ot.unbind(ti, tr, !1));
		...
		function nu(n) {
			var i = n.identifier !== undefined ? n.identifier : 0, t = yu(i);
			return t.end.x = n.pageX || n.clientX, t.end.y = n.pageY || n.clientY, t
		}

		function yu(n) {
			for (var t = 0; t < st.length; t++)if (st[t].identifier == n)return st[t]
		}

		function pu() {
			for (var n = [], t = 0; t <= 5; t++)n.push({start: {x: 0, y: 0}, end: {x: 0, y: 0}, identifier: 0});
			return n
		}
		...
		function bu() {
			var n = {};
			return n[u] = vi(u), n[f] = vi(f), n[e] = vi(e), n[o] = vi(o), n
		}
		...
		function sr(n, t) {
			var i = Math.abs(n.x - t.x), r = Math.abs(n.y - t.y);
		...
		function nf(n, t) {
			var r = n.x - t.x, u = t.y - n.y, f = Math.atan2(u, r), i = Math.round(f * 180 / Math.PI);
		...
		var fi = r || c || !et.fallbackToMouseEvents, ei = fi ? c ? a ? "MSPointerDown" : "pointerdown" : "touchstart" : "mousedown", yi = fi ? c ? a ? "MSPointerMove" : "pointermove" : "touchmove" : "mousemove", pi = fi ? c ? a ? "MSPointerUp" : "pointerup" : "touchend" : "mouseup", ti = fi ? null : "mouseleave", oi = c ? a ? "MSPointerCancel" : "pointercancel" : "touchcancel", at = 0, vt = null, lt = 0, kt = 0, dt = 0, yt = 1, wt = 0, bt = 0, si = null, ot = n(ft), ht = "start", ct = 0, st = null, wi = 0, hi = 0, ci = 0, bi = 0, gt = 0, li = null, ki = null;
		try {
			ot.bind(ei, di);
			ot.bind(oi, ii)
		} catch (ff) {
			n.error("events not supported " + ei + "," + oi + " on jQuery.swipe")
		}
	...
	var u = "left", f = "right", e = "up", o = "down", v = "in", y = "out", p = "none", d = "auto", g = "swipe", nt = "pinch", w = "tap", tt = "doubletap", it = "longtap", b = "horizontal", k = "vertical", l = "all", ut = 10, rt = "start", s = "move", t = "end", i = "cancel", r = "ontouchstart" in window, a = window.navigator.msPointerEnabled && !window.navigator.pointerEnabled, c = window.navigator.pointerEnabled || window.navigator.msPointerEnabled, h = "TouchSwipe";
	...
	n.fn.swipe.phases = {PHASE_START: rt, PHASE_MOVE: s, PHASE_END: t, PHASE_CANCEL: i};
	n.fn.swipe.directions = {LEFT: u, RIGHT: f, UP: e, DOWN: o, IN: v, OUT: y};
	n.fn.swipe.pageScroll = {NONE: p, HORIZONTAL: b, VERTICAL: k, AUTO: d};
	n.fn.swipe.fingers = {ONE: 1, TWO: 2, THREE: 3, ALL: l}
});
/*!
 ...
 */
(function (n) {
	var i = n.event.dispatch || n.event.handle, t = n.event.special, r = "D" + +new Date, u = "D" + (+new Date + 1);
	t.scrollstart = {
		setup: function (u) {
			var o = n.extend({latency: t.scrollstop.latency}, u), f, e = function (n) {
				var t = this, r = arguments;
				f ? clearTimeout(f) : (n.type = "scrollstart", i.apply(t, r));
				f = setTimeout(function () {
					f = null
				}, o.latency)
			};
			n(this).bind("scroll", e).data(r, e)
		}, teardown: function () {
			n(this).unbind("scroll", n(this).data(r))
		}
	};
	t.scrollstop = {
		latency: 250, setup: function (r) {
			var o = n.extend({latency: t.scrollstop.latency}, r), f, e = function (n) {
				var t = this, r = arguments;
				f && clearTimeout(f);
				f = setTimeout(function () {
					f = null;
			...
			n(this).bind("scroll", e).data(u, e)
		}, teardown: function () {
			n(this).unbind("scroll", n(this).data(u))
		}
	}
})(jQuery);
/*!
...
+function (n) {
	...
	t.prototype.slide = function (i, r) {
		var e = this.$element.find(".item.active"), u = r || this.getItemForDirection(i, e), l = this.interval, f = "next" == i ? "left" : "right", v = "next" == i ? "first" : "last", a = this, o, s, h, c;
		if (!u.length) {
...
+function (n) {
	...
	t.prototype.show = function () {
		...
		if (this.hasContent() && this.enabled) {
			...
			if (y) {
				var w = i, b = this.options.container ? n(this.options.container) : this.$element.parent(), e = this.getPosition(b);
...
(function (n) {
	n.fn.jPushMenu = function (t) {
		var i = n.extend({}, n.fn.jPushMenu.defaultOptions, t), r;
		n(this).addClass("jPushMenuBtn");
		n(this).click(function () {
			var t = "", r = "";
			return n(this).is("." + i.showLeftClass) ? (t = ".cbp-spmenu-left", r = "toright") : n(this).is("." + i.showRightClass) ? (t = ".cbp-spmenu-right", r = "toleft") : n(this).is("." + i.showTopClass) ? t = ".cbp-spmenu-top" : n(this).is("." + i.showBottomClass) && (t = ".cbp-spmenu-bottom"), n(this).toggleClass(i.activeClass), n(t).toggleClass(i.menuOpenClass), n(this).is("." + i.pushBodyClass) && n(".cbp-spmenu-push").toggleClass("cbp-spmenu-push-" + r), n(".jPushMenuBtn").not(n(this)).toggleClass("disabled"), !1
		});
		r = {
			close: function () {
				n(".jPushMenuBtn,.cbp-spmenu-push,.cbp-spmenu").removeClass("disabled active cbp-spmenu-open cbp-spmenu-push-toleft cbp-spmenu-push-toright")
			}
		};
		i.closeOnClickOutside && n(document).click(function (t) {
			n(t.target).closest(".cbp-spmenu, #hdr-search").length || r.close()
		})
	};
...
$(window).resize(function () {
	setDevice();
	initializeMMSelects();
	setEqualHeight(".row-equal-col", !device_xs);
	device_xs ? closeFooter() : showFooter()
});
$(window).scroll(function () {
	device_xs && closeFooter()
});
...
jQuery.cookie = function (n, t, i) {
	var u, r, f, e;
	return arguments.length > 1 && String(t) !== "[object Object]" ? (i = jQuery.extend({}, i), (t === null || t === undefined) && (i.expires = -1), typeof i.expires == "number" && (u = i.expires, r = i.expires = new Date, r.setDate(r.getDate() + u)), t = String(t), document.cookie = [encodeURIComponent(n), "=", i.raw ? t : encodeURIComponent(t), i.expires ? "; expires=" + i.expires.toUTCString() : "", i.path ? "; path=" + i.path : "", i.domain ? "; domain=" + i.domain : "", i.secure ? "; secure" : ""].join("")) : (i = t || {}, e = i.raw ? function (n) {
		return n
